...
plt.figure(figsize=(12, 6))
plt.plot(y_test_rescaled, label='Actual Seismic Depth', marker='o')
plt.plot(predictions_rescaled, label='Predicted Seismic Depth', marker='x')
plt.title('Predicted vs Actual Seismic Depths')
plt.xlabel('Time Step')
plt.ylabel('Depth (km)')
plt.legend()
plt.show()

model.save('lstm_seismic_depth_model.h5')
print("Model training complete. Model saved as 'lstm_seismic_depth_model.h5'.")