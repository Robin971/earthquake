...
plt.title('Map of Predicted vs Actual Locations with Magnitudes')
...
model.save('lstm_seismic_combined_model_colored.h5')
print("Model training complete. Model saved as 'lstm_seismic_combined_model_colored.h5'.")